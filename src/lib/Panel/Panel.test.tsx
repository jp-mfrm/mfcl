...
describe('Panel Component', () => {
  it('should render the panelClass prop', () => {
    const { container } = render(
      <Panel panelClass="test-class"></Panel>
    );
  ...
  it('should render the custom inline styling properly', () => {
    const { container } = render(
      <Panel customStyling={{ width: '400px', backgroundColor: 'blue' }}></Panel>
    );
  ...
  it('should render valid children elements', () => {
    const { container } = render(
      <Panel><div>This is valid</div></Panel>
    );
...
describe('PanelItem Component', () => {
  it('should render the itemClass prop', () => {
    const { container } = render(
      <PanelItem itemClass="test-class"></PanelItem>,
    );
  ...
  it('should render the custom inline styling properly', () => {
    const { container } = render(
      <PanelItem customStyling={{ width: '400px', backgroundColor: 'blue' }}></PanelItem>
    );
