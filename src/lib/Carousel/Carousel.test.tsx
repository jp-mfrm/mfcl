...
describe('Carousel Component', () => {
  ...
  it('should render the carouselClass prop', () => {
    const { container } = render(
      <Carousel carouselClass="test-class-name"></Carousel>
    );
