...
const BoxSpring: React.FunctionComponent<Props> = ({ width = '24', height = '8', fillColor = '#2D2926', ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} {...rest} fill="none" viewBox="0 0 24 8">
    <mask id="d5398vi6la" width="26" height="8" x="-1" y="0" maskUnits="userSpaceOnUse">
      <path
        fill="#fff"
        fillRule="evenodd"
    ...
    <g mask="url(#d5398vi6la)">
      <path fill={fillColor} d="M-3 -11H27V19H-3z" />
    </g>
  </svg>
)
