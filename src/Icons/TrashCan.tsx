...
const TrashCan: React.FunctionComponent<Props> = ({ width = '24', height = '15', fillColor = '#2D2926', ...rest }) => (
  <svg fill="none" height="26" viewBox="0 0 23 26" width="23" xmlns="http://www.w3.org/2000/svg">
    <g fill={fillColor}>
      <path clip-rule="evenodd" d="m4 25.5h15.09l2.01-23h-19.1zm14.16-1h-13.24l-1.87-21h16.9z" fill-rule="evenodd" />
    ...
    <path d="m8 .5h7" stroke="#000" stroke-linecap="round" />
  </svg>
)
