...
const Comforter: React.FunctionComponent<Props> = ({ width = '26', height = '16', fillColor = '#2D2926', ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} {...rest} fill="none" viewBox="0 0 26 16">
