...
const Faq: React.FunctionComponent<Props> = ({ width = '22', height = '23', fillColor = '#2D2926', ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} {...rest} fill="none" viewBox="0 0 22 23">
    <mask id="6dji6se08a" width="22" height="23" x="0" y="0" maskUnits="userSpaceOnUse">
      <path
        fill="#fff"
        fillRule="evenodd"
