...
const LowMotion: React.FunctionComponent<Props> = ({ width = '24', height = '22', fillColor = '#2D2926', ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} {...rest} fill="none" viewBox="0 0 24 22">
    <mask id="xb59cjw4ba" width="26" height="22" x="-1" y="0" maskUnits="userSpaceOnUse">
      <path
        fill="#fff"
        fillRule="evenodd"
    ...
    <g mask="url(#xb59cjw4ba)">
      <path fill={fillColor} d="M-3 -4H27V26H-3z" />
    </g>
  </svg>
)

export default LowMotion
